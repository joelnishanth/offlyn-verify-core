...
\begin{enumerate}[leftmargin=*]
  ...
  \item It provides an evaluation protocol for measuring safety leakage, false rejection, latency overhead, bypass resistance, replay resistance, and audit completeness without overstating unimplemented hardware claims.
\end{enumerate}
